from centaurohybridmpc.controllers.horizon_based.centauro_rhc_cluster_client import CentauroRHCLusterClient
...
if __name__ == "__main__":  
    ...
    control_cluster_client = CentauroRHCLusterClient(namespace=namespace, 
